                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live="price_range"
                                ...
                                max="10000000" value="2000000" step="500000">
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(500000, 'VND')}}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(10000000, 'VND')}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="p-3 ">
                                    ...
                                    <p class="text-lg ">
                                        <span class="text-green-600 dark:text-green-600">
                                            {{Number::currency($product->price, 'VND')}}
                                        </span>
                                    </p>
                                </div>
